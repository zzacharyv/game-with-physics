...
public:
    ...
    // Renders texture at given point, stretched into a given rectangle
    void render(int x, int y, SDL_Rect renderQuad, SDL_Renderer *gRenderer, SDL_Rect *clip = NULL, double angle = 0.0, SDL_Point *center = NULL, SDL_RendererFlip flip = SDL_FLIP_NONE);
...
void LTexture::render(int x, int y, SDL_Rect renderQuad, SDL_Renderer *gRenderer, SDL_Rect *clip, double angle, SDL_Point *center, SDL_RendererFlip flip)
{
	// Render to screen
	SDL_RenderCopyEx(gRenderer, mTexture, clip, &renderQuad, angle, center, flip);
}
